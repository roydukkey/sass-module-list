...
<dl>
  ...
  <dt><a href="//github.com/roydukkey/sass-module-list/tree/master/src/list/_empty.sass"><code>empty ( $list )</code></a></dt>
  <dd>Creates an empty list based on the characteristics of the specified list.</dd>
